...
<div class="container-sm bg-primary text-white text-center">
</div>
<div class="container-fluid p-1 bg-dark gray text-white text-center">
</div><br>
</div><br>
</head>
<body>
<div class="container-sm mt-2 border text-end"><br>
    ...
    if ($conn->connect_error){
        ...
        echo "Production Line: ".$dbcon ."<br>";
    }

    $sql = "DELETE FROM $proname";
