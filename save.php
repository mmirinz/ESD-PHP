...
<div class="container-fluid p-1   text-white text-end">
    <div class="btn-group">
        ...
        <form method="get" action="save.php";>
            <button type="submit" class="btn bg-dark  px-5  text-white">Save</button>
        </form>
    </div>
...
<div class="container-sm mt-2 border text-end"><br>
    <form action="shere.php" method="get"><br><br>
        ...
        <button type="submit"  class="btn bg-dark blue  px-4  text-white"> Save </button>
    </form>
    <br><br>
